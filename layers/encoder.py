...
def resnet_multiimage_input(num_layers, pretrained=False, num_input_images=1):
    ...
    assert num_layers in [
        ...
        101,
        152,
    ], "Can only run with 18 or 50 layer resnet"
    blocks = {
        18: [2, 2, 2, 2],
        34: [3, 4, 6, 3],
        50: [3, 4, 6, 3],
    ...
    if pretrained:
        weights_and_model = {
            18: (models.ResNet18_Weights.IMAGENET1K_V1, models.resnet18),
            34: (models.ResNet34_Weights.IMAGENET1K_V1, models.resnet34),
            50: (models.ResNet50_Weights.IMAGENET1K_V2, models.resnet50),
            101: (models.ResNet101_Weights.IMAGENET1K_V2, models.resnet101),
            152: (models.ResNet152_Weights.IMAGENET1K_V2, models.resnet152),
        }
        weights, ref_model = weights_and_model[num_layers]
        ref_model = ref_model(weights=weights)
        loaded = ref_model.state_dict()
